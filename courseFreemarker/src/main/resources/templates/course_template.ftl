    ...
    <div class="article-banner">
        ...
        <div class="banner-info">
            ...
            <div class="banner-rit">
                <p>
                    <a href="http://www.yefan.xyz/course/preview/learning.html?id=${model.courseBase.id}"
                       target="_blank">
                        <#if model.courseBase.pic??>
                            <img src="http://www.yefan.xyz${model.courseBase.pic}" alt="" width="160" height="160">
                        <#else>
                            ...
                            <div class="content-com course">
                                ...
                                <div class="cont">
                                    <div class="img-box"><img
                                                src="http://www.yefan.xyz${model.courseTeacher.photograph}" alt=""
                                    ...
                                    <div class="drop-down" style="height: 260px;">
                                        <ul class="list-box">
                                            <#list firstNode.teachPlanTreeNodes as secondNode>
                                                <li>
                                                    <a href="http://www.yefan.xyz/course/preview/learning.html?id=${model.courseBase.id}&chapter=${secondNode.teachplanMedia.teachplanId!''}"
